...
function modifNavbar() {
    ...
    $.getJSON('login.php', {action: 'isConnected'}, function(rep) {
        if (rep.grade == 'user') {
            $('#navbar-content').append('<ul class="nav"><li><a href="index.html">Accueil</a></li><li><a href="gallerie.html">Gallerie</a></li><li><a href="score.html">Score</a></li></ul><ul  class="nav pull-right"><li ><a href="user.html">' + rep.name + '</a></li><li ><a href="#" id="disconnect">&times;</a></li></ul>');
        } else if (rep.grade == 'admin') {
            $('#navbar-content').append('<ul class="nav"><li><a href="index.html">Accueil</a></li><li><li><a href="gallerie.html">Gallerie</a></li><a href="score.html">Score</a></li></ul><ul  class="nav pull-right"><li ><a href="user.html">' + rep.name + '</a></li><li ><a href="admin.html">Admin</a></li><li ><a href="#" id="disconnect">&times;</a></li></ul>');
        } else {
