...
function modifNavbar() {
    ...
    $.getJSON('login.php', {action: 'isConnected'}, function(rep) {
        if (rep.grade == 'user') {
            $('#navbar-content').append('<ul class="nav"><li><a href="index.html">Accueil</a></li><li><a href="galerie.html">Galerie</a></li><li><a href="blog/">Blog</a></li><li><a href="score.html">Score</a></li></ul><ul  class="nav pull-right"><li ><a href="user.html">' + rep.name + '</a></li><li ><a href="#" id="disconnect">&times;</a></li></ul>');
        } else if (rep.grade == 'admin') {
            $('#navbar-content').append('<ul class="nav"><li><a href="index.html">Accueil</a></li><li><a href="galerie.html">Galerie</a></li><li><a href="blog/">Blog</a></li><li><a href="score.html">Score</a></li></ul><ul  class="nav pull-right"><li ><a href="user.html">' + rep.name + '</a></li><li ><a href="admin.html">Admin</a></li><li ><a href="#" id="disconnect">&times;</a></li></ul>');
        } else {
